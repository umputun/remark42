...
type ServerCommand struct {
	...
	LegacyImageProxy bool          `long:"img-proxy" env:"IMG_PROXY" description:"enable image proxy (deprecated, use image-proxy.http2https)"`
...
func (s *ServerCommand) newServerApp() (*serverApp, error) {
	...
	imgProxy := &proxy.Image{
		HTTP2HTTPS:    s.ImageProxy.HTTP2HTTPS || s.LegacyImageProxy,
